...
class User_Login:
    def __init__(self,root):
        ...
        self.login_b=ImageTk.PhotoImage(Image.open("C:/IMS/icons/button_login.png"))
        log_btn=Label(self.root,image=self.login_b)
        log_btn.place(x = 400, y = 260, height = 350, width = 800)
        self.regs_b=ImageTk.PhotoImage(Image.open("C:/IMS/icons/button_register.png"))
        ...
        self.titlebg=ImageTk.PhotoImage(Image.open("C:/IMS/icons/title.png"))
        ...
        self.logo= ImageTk.PhotoImage(Image.open("C:/IMS/icons/logo.jpg"))
