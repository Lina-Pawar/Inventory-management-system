...
class User_Register:
    def __init__(self,root):
                ...
                try:
                    ...
                    for (mail_id) in cur:
                        if self.usrnew_iden.get() == mail_id:
                            ...
                            login_insert = "INSERT INTO users (f_name , l_name, mail_id , que , answer , password, username) VALUES (%s, %s, %s, %s, %s, %s, %s)"
        ...
        self.usrn_frame = LabelFrame(self.root, text ="SIGN UP", padx = 10, pady = 10, font =("Arial",20),bg="White")
        self.usrn_frame.place(x=650, y=125, height = 550, width = 700)
        usrnew_1st = Label(self.usrn_frame, text = "First Name     : ",font =("Arial",16),bg="White").grid(row = 1, column = 0, padx = 10, pady = 10)
        self.usrnew_1sten = Entry(self.usrn_frame, width = 40, font =("Arial",16))
        self.usrnew_1sten.grid(row = 1, column = 1, padx = 10, pady = 10)
        usrnew_last = Label(self.usrn_frame, text = "Last Name     : ",font =("Arial",16),bg="White").grid(row = 2, column = 0, padx = 10, pady = 10)
        self.usrnew_lasten = Entry(self.usrn_frame, width = 40, font =("Arial",16))
        self.usrnew_lasten.grid(row = 2, column = 1, padx = 10, pady = 10)
        usrnew_id = Label(self.usrn_frame, text = "E-mail id        : ", font =("Arial",16),bg="White").grid(row = 3, column = 0, padx = 10, pady = 10)
        self.usrnew_iden = Entry(self.usrn_frame, width = 40, font =("Arial",16))
        self.usrnew_iden.grid(row = 3, column = 1, padx = 10, pady = 10)
        security = Label(self.usrn_frame, text = "Security Que : ", font =("Arial",16),bg="White").grid(row = 4, column = 0, padx = 10, pady = 10)
        ...
        answer = Label(self.usrn_frame, text = "Answer         : ", font =("Arial",16),bg="White").grid(row = 5, column = 0, padx = 10, pady = 10)
        self.answeren = Entry(self.usrn_frame, width = 40, font =("Arial",16))
        self.answeren.grid(row = 5, column = 1, padx = 10, pady = 10)
        usrnew_pass = Label(self.usrn_frame, text = "Password      : ", font =("Arial",16),bg="White").grid(row = 6, column = 0, padx = 10, pady = 10)
        ...
        usrnew_passcn = Label(self.usrn_frame, text = "Confirm Pass : ", font =("Arial",16),bg="White").grid(row = 7, column = 0, padx = 10, pady = 10)
