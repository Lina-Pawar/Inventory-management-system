...
class Customer:
    def __init__(self,root,id):
       ...
       #----------MANAGE FRAME----------
        ...
        self.manage_frame.place(x=20,y=100,width=600,height=650)
        ...
        #-----------ALL IMAGES--------------
        self.search_b1=ImageTk.PhotoImage(file="D:/IMS/icons/search.png")
        self.add_b1=ImageTk.PhotoImage(file="D:/IMS/icons/add.png")
        self.update_b1=ImageTk.PhotoImage(file="D:/IMS/icons/update.png")
        self.delete_b1=ImageTk.PhotoImage(file="D:/IMS/icons/remove.png")
        self.clear_b1=ImageTk.PhotoImage(file="D:/IMS/icons/clear.png")
        self.show_b1=ImageTk.PhotoImage(file="D:/IMS/icons/show.png")
        self.exit_b=ImageTk.PhotoImage(file="D:/IMS/icons/exit.png")
        #----------BUTTON FRAME----------
        ...
        Exit_btn=Button(self.manage_frame,image=self.exit_b,command=self.Window_Exit,width=52,height=68,font=("Arial",7,"bold"),compound=TOP,pady=6,bg="snow2",fg="black",bd=5)
        Exit_btn.place(x=250,y=540)
          
          
         #----------DETAILS FRAME----------
        self.details_frame=Frame(self.root,bd=5,relief=RIDGE,bg=bg_color)
        self.details_frame.place(x=640,y=100,width=850,height=650)
        ...
        self.table_frame.place(x=10,y=70,width=800,height=540)
